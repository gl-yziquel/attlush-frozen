...
/*
 * Iterator on one then two numeric list Usage at *l,p;			at
 * *l1,*l2,*p1,*p2 iter_list(l,p)		or
 * iter_2_list(l1,p1,l2,p2) {	}			{	}
 * 
 * Note: This iterators destroys the vars l or l1 and l2.
 */
